...
- 从历年题目识别电源、仪器、模拟/RF、通信、控制、机器人、视觉、DSP、FPGA 等知识链。
...
- 18 个按需加载的工程参考模块，覆盖硬件、模拟、电源、通信、控制、视觉、MCU、DSP、FPGA 和现场执行。
...
当前为 `v0.1.0` 初始公开版本。历史题目分类、芯片证据包、真实故障案例、例题和检查工具会按 [`ROADMAP.md`](ROADMAP.md) 持续扩展。
